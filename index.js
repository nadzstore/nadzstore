...
/////////////////
const BotName = 'NADZ BOT'; 
const instagram = 'https://instagram.com/gameholicshop_'; 
const telegram = 'https://t.me/alfika_r'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'Faxx Official';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@gameholicshop_')
